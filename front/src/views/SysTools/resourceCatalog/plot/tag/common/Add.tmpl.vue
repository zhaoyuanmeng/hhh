 ...
 * @Date: 2022.11.28
 * @LastEditors: Alex
 * @LastEditTime: 2024-06-20 16:11:50
 -->
<template>
  <div>
...
export default {
  ...
  data() {
    return {
      ...
      labelList: [
        {
          src: loadPicture("./images/cloud/label-1.png"),
        },
        {
          src: loadPicture("./images/cloud/label-2.png"),
        },
        {
          src: loadPicture("./images/cloud/label-3.png"),
        },
        {
          src: loadPicture("./images/cloud/label-4.png"),
        },
        {
          src: loadPicture("./images/cloud/label-5.png"),
        },
        {
          src: loadPicture("./images/cloud/label-6.png"),
        },
        {
          src: loadPicture("./images/cloud/label-7.png"),
        },
        {
          src: loadPicture("./images/cloud/label-8.png"),
        },
        {
          src: loadPicture("./images/cloud/label-9.png"),
        },
        {
          src: loadPicture("./images/cloud/sb-sxj.png"),
        },
        {
          src: loadPicture("./images/cloud/nav_iot.png"),
        },
      ],
      image: undefined,
      imageWidth: 0,
  ...
  methods: {
    ...
    handleSubmit () {
      ...
      fontImage.onload = function () {
        ...
        range: [0, 18000], //可视范围
        // imagePath:"C:\\teqin\\images\\cloud\\label-1.png",
