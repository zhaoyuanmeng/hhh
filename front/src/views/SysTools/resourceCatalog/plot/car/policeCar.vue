 ...
 * @Date: 2022.11.28
 * @LastEditors: Alex
 * @LastEditTime: 2024-06-20 15:49:22
 -->
<template>
  <div>
      ...
      <div class="func-warp">
        <el-scrollbar>
          <div v-for="(item, index) in dataList"
            :key="index" @click.stop="handleClickLabel(item, index)" @dblclick.stop="handleDbClick(item, index)">
        ...
        <div class="warp-footer">
          <div @click="handleLabelAdd">新增警车</div>
        </div>
      </div>
    </div>
...
<script>
import AddTmpl from "./addCar.vue";
