        ...
        <template v-if="!editHelper.flag">
            <div v-if="isShowAddPoint" class="cloud-func draw-list">
                ...
                <div class="func-warp">
                    <div class="warp-list">
                        <el-scrollbar>
                            <div class="list" v-for="(item, index) in surfaceList" :key="index">
                    ...
                    <div class="button-wrap">
                        <div @click="drawParam()"> <i class="el-icon-plus"></i> 新增体 </div>
                    </div>
                </div>
            </div>

            <div v-if="isShowPonitModel" class="cloud-func draw-form">
                <div class="func-title">新增体</div>
                <el-scrollbar style="height: 100%">
                    <div class="func-warp">
                        ...
                        <div class="warp-list">
                            <p>样式</p>
                            <el-select v-model="option.style" @change="handleChange" placeholder="请选择">
                        ...
                        <div class="warp-list">
                            <p>高度（米）</p>
                            <div class="input-box">
                                <el-slider v-model="option.height" @change="handleChange" :min="1" :max="1000"
                                    :step="10"></el-slider>
                                <el-input-number v-model="option.height" controls-position="right" :min="1" :max="1000"
                        ...
                        <div class="warp-list">
                            <p>亮度</p>
                            <div class="input-box">
                                <el-slider v-model="option.intensity" @change="handleChange" :min="0" :max="1000"
                                    :step="10"></el-slider>
                                <el-input-number v-model="option.intensity" controls-position="right" :min="0" :max="1000"
                                    :step="1" @change="handleChange"></el-input-number>
                            </div>
                        </div>
                        <div class="warp-list">
                            <p>X重复度</p>
                            <div class="input-box">
                                <el-slider v-model="option.tillingX" @change="handleChange" :min="0" :max="1"
                                    :step="0.1"></el-slider>
                                <el-input-number v-model="option.tillingX" controls-position="right" :min="0" :max="1"
                        ...
                        <div class="warp-list">
                            <p>Y重复度</p>
                            <div class="input-box">
                                <el-slider v-model="option.tillingY" @change="handleChange" :min="0" :max="1"
                                    :step="0.1"></el-slider>
                                <el-input-number v-model="option.tillingY" controls-position="right" :min="0" :max="1"
                                    :step="0.1" @change="handleChange"></el-input-number>
                            </div>
                        </div>
...
const defaultOption = {
    ...
    style: 1, // 样式 单色1 ，取值范围：[0~8]
    height: 20, // 边框厚度 [0~100]
...
export default {
    ...
    methods: {
        // 获取数据库体
        async getPolygon3d() {
            let data = sessionStorage.getItem("QXZS_polygon3d")
        ...
        async initData(opr) {
            ...
            // 初始效果
            if (opr === 'init') {
                await window.origAPI.polygon3d.clear(); 1
        ...
        deletePolygon3d(data, index) {
            ...
            sessionStorage.setItem("QXZS_polygon3d", JSON.stringify(this.surfaceList))
        },
        _colorBuild(option) {
        ...
        async savePolygon3d(obj) {
            ...
            sessionStorage.setItem("QXZS_polygon3d", JSON.stringify(data))
        ...
        async handleCancel() {
            ...
            if (this.editIndex < 0) await window.origAPI.polygon3d.delete(this.option.id);
